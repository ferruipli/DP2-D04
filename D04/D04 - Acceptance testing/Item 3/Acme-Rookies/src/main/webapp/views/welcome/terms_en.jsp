...
<h2 style="text-align: center;">
	<strong>Terms and Conditions for acme</strong>
</h2>

<h2>Introduction</h2>

<p>These Website Standard Terms and Conditions written on this
	webpage shall manage your use of our website, acme accessible at
	acme.com.</p>
...
<p>Other than the content you own, under these Terms, acme and/or
...
<ul>
	...
	<li>engaging in any data mining, data harvesting, data extracting
		or any other similar activity in relation to this Website;</li>
	<li>using this Website to engage in any advertising or marketing.</li>
</ul>

<p>Certain areas of this Website are restricted from being access by
	you and acme may further restrict access by you to any areas of this
...
<p>In these Website Standard Terms and Conditions, "Your Content"
	...
	to display on this Website. By displaying Your Content, you grant acme
...
<p>Your Content must be your own and must not be invading any
	third-party’s rights. acme reserves the right to remove any of Your
...
<p>This Website is provided "as is," with all faults, and acme
...
<p>In no event shall acme, nor any of its officers, directors and
	...
	under contract.  acme, including its officers, directors and employees
...
<p>You hereby indemnify to the fullest extent acme from and against
...
<p>acme is permitted to revise these Terms at any time as it sees
	fit, and by using this Website you are expected to review these Terms
	on a regular basis.</p>

<h2>Assignment</h2>

<p>The acme is allowed to assign, transfer, and subcontract its
...
<p>These Terms constitute the entire agreement between acme and you
	in relation to your use of this Website, and supersede all prior
	agreements and understandings.</p>

<h2>Governing Law y Jurisdiction</h2>

<p>These Terms will be governed by and interpreted in accordance
	with the laws of the State of es, and you submit to the non-exclusive
	jurisdiction of the state and federal courts located in es for the
